...
const IBN_KATHIR_GAPS = ['105:1', '105:2', '105:3', '105:4', '105:5'];
...
function main(argv = process.argv.slice(2)) {
  ...
  for (const source of [{ key: 'ibn_kathir', count: 6231, gaps: IBN_KATHIR_GAPS }, { key: 'al_sadi', count: 6177, gaps: AL_SADI_GAPS }]) {
    const files = [];
    const actualKeys = [];
...
module.exports = { AL_SADI_GAPS, IBN_KATHIR_GAPS, main };
