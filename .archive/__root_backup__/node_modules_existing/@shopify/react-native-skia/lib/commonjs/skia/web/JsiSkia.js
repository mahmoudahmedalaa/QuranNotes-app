...
var _JsiSkPathBuilderFactory = require("./JsiSkPathBuilderFactory");
...
var _JsiSkottieFactory = require("./JsiSkottieFactory");
const JsiSkApi = CanvasKit => ({
  ...
  ContourMeasureIter: (path, forceClosed, resScale) => (() => {
    ...
    const iter = new _JsiSkContourMeasureIter.JsiSkContourMeasureIter(CanvasKit, new CanvasKit.ContourMeasureIter(p, forceClosed, resScale));
    p.delete();
    return iter;
  })(),
  Paint: () => {
  ...
  PathBuilder: new _JsiSkPathBuilderFactory.JsiSkPathBuilderFactory(CanvasKit),
  ...
  Skottie: new _JsiSkottieFactory.JsiSkottieFactory(CanvasKit),
