...
import { type SharedValue, type WithSpringConfig, type WithTimingConfig } from 'react-native-reanimated';
...
export type AnimationConfigs = {
     ...
     */
    validationLeftSwipeTimingConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithTimingConfig;
    /**
     ...
     * @default undefined - spring animation is used by default
     */
    validationRightSwipeTimingConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithTimingConfig;
    /**
     ...
     * @default undefined - spring animation is used by default
     */
    validationBottomSwipeTimingConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithTimingConfig;
    /**
     ...
     * @default undefined - spring animation is used by default
     */
    validationTopSwipeTimingConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithTimingConfig;
    /**
     ...
     */
    validationLeftSwipeSpringConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithSpringConfig;
    /**
     * Configuration for spring animation when validating right swipe.
     * Called when gesture ends and swipe threshold is met for right direction.
     * @default (event) => ({ type: 'spring', duration: 300, easing: Easing.inOut(Easing.quad), reduceMotion: ReduceMotion.System, velocity: event.velocityX / windowWidth })
     */
    validationRightSwipeSpringConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithSpringConfig;
    /**
     ...
     */
    validationBottomSwipeSpringConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithSpringConfig;
    /**
     * Configuration for spring animation when validating top swipe.
     * Called when gesture ends and swipe threshold is met for top direction.
     * @default (event) => ({ type: 'spring', duration: 300, easing: Easing.inOut(Easing.quad), reduceMotion: ReduceMotion.System, velocity: event.velocityY / windowHeight })
     */
    validationTopSwipeSpringConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithSpringConfig;
    /**
     ...
     * @default () => ({ type: 'timing', duration: 300, easing: Easing.inOut(Easing.quad), reduceMotion: ReduceMotion.System })
     */
    canceledHorizontalSwipeTimingConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithTimingConfig;
    /**
     ...
     * @default () => ({ type: 'timing', duration: 300, easing: Easing.inOut(Easing.quad), reduceMotion: ReduceMotion.System })
     */
    canceledVerticalSwipeTimingConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithTimingConfig;
    /**
     * Configuration for spring animation when horizontal swipe is canceled.
     * Called when gesture ends and neither translation nor velocity threshold is met for horizontal direction.
     * @default undefined - timing animation is used by default
     */
    canceledHorizontalSwipeSpringConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithSpringConfig;
    /**
     * Configuration for spring animation when vertical swipe is canceled.
     * Called when gesture ends and neither translation nor velocity threshold is met for vertical direction.
     * @default undefined - timing animation is used by default
     */
    canceledVerticalSwipeSpringConfig?: (event: GestureStateChangeEvent<PanGestureHandlerEventPayload>) => WithSpringConfig;
};
